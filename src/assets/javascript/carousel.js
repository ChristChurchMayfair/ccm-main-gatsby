...
class Carousel {
    constructor(rootElement) {
        ...
        this.pictures = Array.from(
            this.rootElement.getElementsByClassName("carousel-image")
        )
    ...
    setCurrentSlide(newCurrentSlideIndex) {
        ...
        setTimeout(
            ...
            }.bind(this.pictures[this.currentSlideIndex]),
            10
        )
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var carouselRoots = Array.from(
        document.querySelectorAll(".carousel-images")
    )
