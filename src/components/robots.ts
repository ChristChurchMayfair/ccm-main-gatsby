...
function checkSet(on: string | undefined, off: string, value: boolean | undefined ): string| undefined {
...
export function generateRobotsMetaTag(robotsMetaData: RobotsMetaData): MetaTag {
    ...
    content.push(checkSet(undefined, "noimageindex", robotsMetaData.allowImageIndexing))
    content.push(checkSet("follow", "nofollow", robotsMetaData.allowFollowLinksOnThisPage))
    ...
    content.push(checkSet(undefined, "nosnippet", robotsMetaData.allowPageSnippets))
